...
(function (scenes) {
    /**
     * The Level 3 class is where the main action occurs for the game
     *
     * @class Level3
     */
    var Level3 = (function (_super) {
        ...
        Level3.prototype.addLevel = function () {
            ...
            this.goal.position.set(0, 105, 0);
            this.goal.name = "goal";
            this.add(this.goal);
        };
        /**
